...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220510_esterel_d714390a95ff84796660_20220510131834_archive.zip';
	const ARCHIVE_SIZE		 = '78396997';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd714390-10131834';
    const SECONDARY_PACKAGE_HASH = '3dc9d3a-10131834';
	const VERSION			 = '1.4.2';
